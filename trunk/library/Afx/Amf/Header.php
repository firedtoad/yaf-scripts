<?php
/*
 * @version $Id: Header.php 94 2012-12-10 03:39:40Z zhujinghe $
 */
...
/**
 * Afx_Amf_Header is a data type that represents a single header passed via Amf
 *
 * @package Afx_Amf
 */

class Afx_Amf_Header
{
	/**
	...
	/**
	 * Afx_Amf_Header is the Constructor function for the Afx_Amf_Header data type.
	 */
