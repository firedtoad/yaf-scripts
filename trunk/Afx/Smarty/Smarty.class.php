...
if (! defined('SMARTY_RESOURCE_CHAR_SET')) {
    ...
    define('SMARTY_RESOURCE_CHAR_SET', 
    SMARTY_MBSTRING ? 'UTF-8' : 'ISO-8859-1');
}
...
class Smarty extends Smarty_Internal_TemplateBase
{
     ...
     * @return integer number of cache files deleted
     */
    public function clearCache ($template_name, $cache_id = null, $compile_id = null, 
    ...
    public function enableSecurity ($security_class = null)
    {
        if ($security_class instanceof Smarty_Security) {
            ...
            "Class '" . get_class($security_class) .
        ...
        if (! class_exists($security_class)) {
         ...
         ! is_subclass_of($security_class, 'Smarty_Security')) {
            throw new SmartyException(
    ...
    public function addDefaultModifiers ($modifiers)
    {
        if (is_array($modifiers)) {
            $this->default_modifiers = array_merge($this->default_modifiers, 
            $modifiers);
        } else {
    ...
    public function addAutoloadFilters ($filters, $type = null)
    {
        if ($type !== null) {
            if (! empty($this->autoload_filters[$type])) {
                $this->autoload_filters[$type] = array_merge(
                $this->autoload_filters[$type], (array) $filters);
            } else {
                $this->autoload_filters[$type] = (array) $filters;
            }
            ...
            foreach ((array) $filters as $key => $value) {
                if (! empty($this->autoload_filters[$key])) {
                    $this->autoload_filters[$key] = array_merge(
     ...
     */
    public function createTemplate ($template, $cache_id = null, $compile_id = null, 
    $parent = null, $do_clone = true)
    {
        ...
        if ($this->allow_ambiguous_resources) {
            ...
            $_templateId = $this->joined_template_dir . '#' . $template .
             $cache_id . $compile_id;
        }
        ...
        if ($do_clone) {
            if (isset($this->template_objects[$_templateId])) {
                ...
                $tpl = new $this->template_class($template, clone $this, $parent, 
                $cache_id, $compile_id);
            }
        } else {
            if (isset($this->template_objects[$_templateId])) {
                ...
                $tpl = new $this->template_class($template, $this, $parent, 
                $cache_id, $compile_id);
            }
        }
    ...
    public function loadPlugin ($plugin_name, $check = true)
    {
        ...
        if ($check &&
         (is_callable($plugin_name) || class_exists($plugin_name, false))) {
            return true;
        }
            ...
            foreach ($names as $file) {
                ...
                if ($this->use_include_path &&
                 ! preg_match('/^([\/\\\\]|[a-zA-Z]:[\/\\\\])/', $_plugin_dir)) {
                    ...
                    if (($file = Smarty_Internal_Get_Include_Path::getIncludePath(
                    $file)) !== false) {
                        require_once ($file);
                        return $file;
                    }
     ...
     */
    public function compileAllTemplates ($extention = '.tpl', $force_compile = false, 
    $time_limit = 0, $max_errors = null)
    {
        return Smarty_Internal_Utility::compileAllTemplates($extention, 
     ...
     * @return integer number of template files recompiled
     */
    public function compileAllConfig ($extention = '.conf', $force_compile = false, 
    $time_limit = 0, $max_errors = null)
    {
        return Smarty_Internal_Utility::compileAllConfig($extention, 
        $force_compile, $time_limit, $max_errors, $this);
    }
    /**
     ...
     */
    public function clearCompiledTemplate ($resource_name = null, $compile_id = null, 
    $exp_time = null)
    {
        return Smarty_Internal_Utility::clearCompiledTemplate($resource_name, 
        $compile_id, $exp_time, $this);
    }
    /**
        ...
        if (! $_is_muted_directory ||
         ($errno && $errno & error_reporting())) {
            if (Smarty::$_previous_error_handler) {
                return call_user_func(Smarty::$_previous_error_handler, $errno, 
...
function smartyAutoload ($class)
{
    ...
    $_classes = array('smarty_config_source' => true, 
    'smarty_config_compiled' => true, 'smarty_security' => true, 
    'smarty_cacheresource' => true, 'smarty_cacheresource_custom' => true, 
    'smarty_cacheresource_keyvaluestore' => true, 'smarty_resource' => true, 
    'smarty_resource_custom' => true, 'smarty_resource_uncompiled' => true, 
